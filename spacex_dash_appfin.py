...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.P("Payload range (Kg):"), dcc.RangeSlider(id='payload_slider',
...
def get_scatter_plot(site_dropdown, payload_slider):
    ...
    filter_df = spacex_df[mask]
    if site_dropdown == 'ALL':
        fig = px.scatter(filter_df, x="Payload Mass (kg)", y="class", 
        color="Booster Version Category")
        return fig
    else:
        fig = px.scatter(filtered_df[filtered_df['Launch Site']==site_dropdown], x="Payload Mass (kg)", y="class", 
        color="Booster Version Category")
        return fig
